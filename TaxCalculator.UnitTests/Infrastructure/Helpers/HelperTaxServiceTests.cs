...
namespace TaxCalculator.UnitTests.Infrastructure.Helpers
{
    public class HelperTaxServiceTests
    {
        ...
        [Fact]
        public void HelperTaxCalculation_TaxableIncome_With_Income_Higher_Than_Threshold_Should_Return_TaxableIncome()
        {
        ...
        [InlineData(1000, 0)]
        [InlineData(700, 0)]
        public void HelperTaxCalculation_TaxableIncome_With_Income_Less_Than_Or_Equal_Threshold_Should_Return_Zero(decimal grossIncome, decimal expected)
        {
        ...
        public void HelperTaxCalculation_CharityAdjustment_With_CharitySpent_Should_Return_Adjustment(decimal grossIncome, decimal charitySpent, decimal expected)
        {
        ...
        public void HelperTaxCalculation_CharityAdjustment_With_CharitySpent_Higher_than_MaxRate_Should_Return_MaxRate_Adjustment(decimal grossIncome, decimal charitySpent, decimal expected)
        {
        ...
        [Fact]
        public void HelperTaxCalculation_AdjustTaxableIncome_With_Positive_Income_And_Charity_Should_Return_Adjusted_Income()
        {
        ...
        [Fact]
        public void HelperTaxCalculation_AdjustTaxableIncome_With_Negative_Result_Should_Return_Zero()
        {
